...
function wds_acme_customize_scripts() {
	wp_enqueue_script( 'oneortwo-ltd-customize-livepreview', get_template_directory_uri() . '/inc/customizer/assets/scripts/livepreview.js', [ 'jquery', 'customize-preview' ], '1.0.0', true );
}
