	...
	<div class="scaffolding-document accordion <?php echo esc_attr( $class ); ?>">
		...
		<div class="accordion-item">
			...
			<header class="scaffolding-document-header display-flex flex-start space-between accordion-item-header">
				...
				<button type="button" class="scaffolding-button"><?php esc_html_e( 'Details', 'oneortwo-ltd' ); ?></button>
			...
			<div class="scaffolding-document-content accordion-item-content">
				...
				<?php if ( $args['description'] ) : ?>
					<p><strong><?php esc_html_e( 'Description', 'oneortwo-ltd' ); ?>:</strong></p>
					<p class="scaffolding-document-description"><?php echo esc_html( $args['description'] ); ?></p>
				<?php endif; ?>

				<?php if ( $args['parameters'] ) : ?>
					<p><strong><?php esc_html_e( 'Parameters', 'oneortwo-ltd' ); ?>:</strong></p>
				...
				<?php if ( $args['arguments'] ) : ?>
					<p><strong><?php esc_html_e( 'Arguments', 'oneortwo-ltd' ); ?>:</strong></p>
				...
				<?php if ( $args['usage'] ) : ?>
					<p><strong><?php esc_html_e( 'Usage', 'oneortwo-ltd' ); ?>:</strong></p>
					<pre><?php echo esc_html( $args['usage'] ); ?></pre>
				<?php endif; ?>

				<?php if ( $args['output'] ) : ?>
					<p><strong><?php esc_html_e( 'HTML Output', 'oneortwo-ltd' ); ?>:</strong></p>
